...
# CAMAttention
"""
@FileName：MCAMAttention.py\n
@Description：添加到YOLO11的骨架中，使得模型从通道、高度、宽度三个维度的协同建模，动态捕捉关键特征\n
@Author：ltw\n
@Time：2025/5/13 21:02\n
"""
import torch
from torch import nn
import math

__all__ = ['MCAMAttention', 'MCAGate']
...
class MCAMAttention(nn.Module):
    def __init__(self, inp, no_spatial=False):
        ...
        """
        super(MCAMAttention, self).__init__()
...
# CAFMAttention
"""
@FileName：CAFMAttention.py\n
@Description：在YOLO11的骨架部分添加CAFMAttention优化提取小目标和遮挡特征\n
@Author：ltw\n
@Time：2025/5/13 21:21\n
"""
