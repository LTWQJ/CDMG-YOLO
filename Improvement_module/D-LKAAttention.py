"""
@FileName：D-LKAAttention.py\n
@Description：利用D-LKA模块该井YOLO11的C3K2模块\n
@Author：ltw\n
@Time：2025/5/13 20:28\n
"""
import torch
...
if __name__ == '__main__':
    ...
    lka_layer_exp = deformable_LKA_Attention_experimental(d_model=96)
    lka_layer = deformable_LKA_Attention(d_model=96)
